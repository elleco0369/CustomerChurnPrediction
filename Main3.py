...
threshold_val = np.mean(importances) + np.std(importances)
...
print(f"Orijinal sütun sayısı: {X.shape[1]}")
print(f"Seçilen sütun sayısı : {len(selected_feats)}")
...
evaluate("Random Forest (sel)", y_test, y_pred_rf)
